...
var getOrderById = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
...
var orderControllers = function (app) {
    app.get("/order/:userid", authen_1.verifyAuthToken, getOrderById);
};
