...
describe("Test api", function () {
    ...
    describe("Test api insert user ", function () {
        ...
        console.log("🚀 ~ file: UserControllerTest.ts:21 ~ describe ~ dataObj:", dataObj);
        it("Register", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.post(url).send({
                            id: 0,
                            fristname: "Test",
                            lastname: "Test",
                            password: "12345",
    ...
    describe("Test api with token", function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                userStore.insert(user);
                return [2 /*return*/];
        ...
        it("Have token", function () { return __awaiter(void 0, void 0, void 0, function () {
